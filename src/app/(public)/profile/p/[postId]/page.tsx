...
const PhotoViewPage = () => {
  ...
  return (
    <main className="fixed inset-0 z-50 flex items-center justify-center p-10 text-white backdrop-blur-[1.2px]">
      <div onClick={handleClickBack} className="absolute top-10 right-10">
        <IconX />
      </div>
      <div className="mx-auto grid h-full w-full grid-cols-1 overflow-hidden sm:max-w-3xl sm:min-w-5xl sm:grid-cols-2">
